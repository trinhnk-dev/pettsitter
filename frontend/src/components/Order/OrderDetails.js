          ...
          <div className="orderDetailsPage">
            <div className="orderDetailsContainer">
              ...
              <div className="orderDetailsContainerBox">
                ...
                <div>
                  <p>Amount: </p>
                  <span>{order?.totalPrice && formatCurrency(order?.totalPrice ? order.totalPrice : "")}</span>
                </div>
              </div>
              ...
              <div className="orderDetailsContainerBox">
                <div>
                  <p
                    className={
                      order?.orderStatus && (order?.orderStatus ? order.orderStatus : "") === "Delivered"
                        ? "greenColor"
                        : "redColor"
                    }
                  >
                    {order?.orderStatus && (order?.orderStatus ? order.orderStatus : "")}
                  </p>
                </div>
              </div>
            </div>
